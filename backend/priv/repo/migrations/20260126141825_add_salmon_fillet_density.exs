defmodule Controlcopypasta.Repo.Migrations.AddSalmonFilletDensity do
  ...
  def up do
    ...
    # Only insert if the canonical ingredient exists (may not exist in test database)
    execute """
    ...
    SELECT
      ...
      NOW()
    WHERE EXISTS (
      SELECT 1 FROM canonical_ingredients
      WHERE id = '2f9b7331-5ae1-4bdb-b5f6-3772d39086c5'
    )
    AND NOT EXISTS (
